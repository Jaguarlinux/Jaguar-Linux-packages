...
- `DULGE_TARGET_NO_ATOMIC8` The target machine lacks native 64-bit atomics (needs libatomic emulation).
...
The supported build options for a source package can be shown with `dulge-src`:

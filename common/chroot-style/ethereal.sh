...
if [ "${DULGE_ALLOW_CHROOT_BREAKOUT}" != "yes" ]; then
	msg_red "chroot-style 'ethereal' requires DULGE_ALLOW_CHROOT_BREAKOUT=yes\n"
...
# dulge-src may send some other binds, parse them here
...
# Tell dulge-src that we are "in the chroot"

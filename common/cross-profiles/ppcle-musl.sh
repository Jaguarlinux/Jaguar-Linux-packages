...
DULGE_TARGET_MACHINE="ppcle-musl"
DULGE_TARGET_QEMU_MACHINE="ppcle"
DULGE_CROSS_TRIPLET="powerpcle-linux-musl"
...
DULGE_CROSS_RUST_TARGET="powerpcle-unknown-linux-musl"
DULGE_CROSS_ZIG_TARGET="powerpcle-linux-musl"

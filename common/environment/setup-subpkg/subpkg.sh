...
# dulge-triggers: system-accounts
unset -v system_accounts system_groups

# dulge-triggers: font-dirs
unset -v font_dirs

# dulge-triggers: xml-catalog
unset -v xml_entries sgml_entries xml_catalogs sgml_catalogs

# dulge-triggers: pycompile
unset -v pycompile_dirs pycompile_module

# dulge-triggers: dkms
unset -v dkms_modules

# dulge-triggers: kernel-hooks
unset -v kernel_hooks_version

# dulge-triggers: mkdirs
unset -v make_dirs

# dulge-triggers: binfmts
unset -v binfmts

# dulge-triggers: register-shell

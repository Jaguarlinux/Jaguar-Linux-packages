...
DULGE_PREPKG_DONE="${DULGE_STATEDIR}/${PKGNAME}_${DULGE_CROSS_BUILD}_prepkg_done"

if [ -z "$DULGE_BUILD_FORCEMODE" -a -f $DULGE_PREPKG_DONE ]; then
    exit 0
fi
